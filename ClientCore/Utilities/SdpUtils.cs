...
namespace PeerConnectionClient.Utilities
{
    ...
    class SdpUtils
    {
        ...
        /// <param name="audioCodecName">Audio codec.</param>
        /// <param name="videoCodecName">Video codec.</param>
        /// <returns>True if succeeds to force to use the selected audio/video codecs.</returns>
        public static bool SelectCodecs(ref string sdp, string audioCodecName, string videoCodecName)
        {
